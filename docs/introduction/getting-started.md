...
You can download Clash core binaries here: [https://github.com/siding9241/clash/releases](https://github.com/siding9241/clash/releases)
...
```shell
$ go install github.com/siding9241/clash@latest
go: downloading github.com/siding9241/clash v1.15.1
```
...
```shell
$ git clone --depth 1 https://github.com/siding9241/clash
Cloning into 'clash'...
...
GOARCH=arm64 GOOS=darwin CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/siding9241/clash/constant.Version=unknown version" -X "github.com/siding9241/clash/constant.BuildTime=Mon May  8 16:47:10 UTC 2023" -w -s -buildid=' -o bin/clash-darwin-arm64
$ file bin/clash-darwin-arm64
bin/clash-darwin-arm64: Mach-O 64-bit executable arm64
```

For other build targets, check out the [Makefile](https://github.com/siding9241/clash/blob/master/Makefile).
