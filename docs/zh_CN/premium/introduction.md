...
在过去, 只有一个开源版本的 Clash, 直到一些 [不当使用和再分发](https://github.com/siding9241/clash/issues/541#issuecomment-672029110) 的 Clash 出现. 从那时起, 我们决定分叉 Clash 并在私有 GitHub 存储库中开发更高级的功能.
...
您可以从 [GitHub Releases](https://github.com/siding9241/clash/releases/tag/premium) 下载最新的 Clash Premium 二进制文件.
