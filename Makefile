...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/siding9241/clash/constant.Version=$(VERSION)" \
		-X "github.com/siding9241/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
